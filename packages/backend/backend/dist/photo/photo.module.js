...
const photo_pipe_1 = require("./photo.pipe");
...
PhotoModule = __decorate([
    common_1.Module({
        ...
        providers: [photo_pipe_1.PhotoPipe, photo_service_1.PhotoService],
        exports: [photo_pipe_1.PhotoPipe, photo_service_1.PhotoService],
    })
], PhotoModule);
