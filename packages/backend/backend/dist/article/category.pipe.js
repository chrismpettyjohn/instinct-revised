...
let CategoryPipe = class CategoryPipe {
    ...
    transform(categoryID) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.articleCategoryRepo.findOneOrFail({ id: categoryID });
            }
            catch (_a) {
                throw new common_1.NotFoundException('Article category does not exist');
            }
        });
    }
};
CategoryPipe = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [database_1.ArticleCategoryRepository])
], CategoryPipe);
