...
let GroupController = class GroupController {
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return groups.map(group => group_1.groupWire(group));
        });
    }
    getByID(group) {
        return group_1.groupWire(group);
    }
};
__decorate([
    common_1.Get(),
...
__decorate([
    ...
    __param(0, common_1.Param('groupID', group_pipe_1.GroupPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [group_1.GroupEntity]),
