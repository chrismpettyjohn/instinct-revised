...
let ArticleRepository = class ArticleRepository {
    ...
    create(article) {
        return __awaiter(this, void 0, void 0, function* () {
            const newArticle = yield this.articleRepo.save(article);
    ...
    updateByID(articleID, changes) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.articleRepo.update(articleID, changes);
        });
    }
    deleteByID(articleID) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.articleRepo.delete(articleID);
        });
    }
};
